...
\hrulefill
\begin{itemize}
  \customitem \textbf{Computational Biologist} - \textit{Sequence Bio Inc.}
    \begin{itemize}
    ...
    \end{itemize}
  \customitem \textbf{Research Programmer} - \textit{BC Genome Sciences Center}
    \begin{itemize}
    ...
    \end{itemize}
  \customitem \textbf{Biosensor R\&D Co-op Programmer} - \textit{CiBER Lab, SFU}
    \begin{itemize}
    ...
    \end{itemize}
  \customitem \textbf{Genetics Co-op Student} - \textit{Istanbul University Genetics Institute}
    \begin{itemize}
